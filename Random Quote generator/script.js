...
let clik = () => {
    let qt = document.getElementById("line");
    let sr = document.getElementById("src");
    let theqrt = getQuote();
    qt.innerHTML = theqrt.quote;
    sr.innerHTML = `~ ${theqrt.source}`;
}
let sndClk= new Audio("clicksound.wav");

let genBut= document.querySelector(".gen");
